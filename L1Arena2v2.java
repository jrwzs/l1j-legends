...
public class L1Arena2v2 {
	private static final Logger _log = 
		Logger.getLogger(L1Arena2v2.class.getName());
	...
	private static L1Arena2v2 _instance;

	public static L1Arena2v2 getInstance() {
		if (_instance == null) {
			_instance = new L1Arena2v2();
		}
...
//		                	_log.info("Map Capacity before: " + L1Arena.getInstance().getMembersCount());
							...
							L1Arena2v2.getInstance().removeMember(p);
//		                	_log.info("Map Capacity after: " + L1Arena.getInstance().getMembersCount());
						}
					}

					if (_counter == 5 || L1Arena2v2.getInstance().getMembersCount() == 1 ) { 
						
						// adding W/L later
						this.cancel();
						L1Arena2v2.getInstance().endArena();
						return;
					}
				}
			} catch (Throwable e) {
