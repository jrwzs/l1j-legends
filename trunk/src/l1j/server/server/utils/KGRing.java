...
public class KGRing {
    ...
    public static void  getStats()
    {
        ...
        myStats[24] = "regist_stun";
        myStats[25] = "regist_stone";
        myStats[26] = "regist_sleep";
        myStats[27] = "regist_freeze";
        myStats[28] = "regist_sustain";
        myStats[29] = "regist_blind";
        ...
        */
        ...
        for(int i=0;i<howMany;i++)
        {
            ...
            int wStatID = (int) Math.floor((Math.random()*29));

            while(hasAlready.indexOf("[" + wStatID + "]") != -1)
            {
                wStatID = (int) Math.floor((Math.random()*29));
            }
    ...
    private static void resetKGRing()
    {
        ...
        sqlReset += "defense_water = 0,defense_wind = 0,defense_fire = 0,defense_earth =0,regist_stun = 0,regist_stone = 0,regist_sleep = 0,regist_freeze =0,regist_sustain =0,regist_blind = 0,";
        sqlReset += "add_primary = 0 WHERE item_id = 30001; ";
