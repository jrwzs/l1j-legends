...
public class L1PcInstance extends L1Character
{
    ...
    public int getEr() {
        ...
        // updating elf's ER to level / 5 - [Hank]
        else if ((isElf()))
        {
        	er = getLevel() / 5;
        }
        
        // updating elf's ER to level /4 - [Hank]
        else if (isDarkelf()) {
            er = getLevel() / 4;
        }
        else if (isWizard()) {
        ...
        if ((getLevel() == 99) && (Config.ALT_REVIVAL_POTION)) {
            try {
                ...
                if (l1item != null) {
                    ...
                    sendPackets(new S_SystemMessage("Ã¨Â¿â€�Ã§â€�Å¸Ã¨â€”Â¥Ã¦Â°Â´Ã¥ï¿½â€“Ã¥Â¾â€”Ã¥Â¤Â±Ã¦â€¢â€”Ã£â‚¬â€š"));
                }
            }
            catch (Exception e) {
                _log.log(Level.SEVERE, e.getLocalizedMessage(), e);
