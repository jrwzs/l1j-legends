...
public class L1Quest {
    ...
    public static final int QUEST_TUTOR = 300;//æ–°æ‰‹å°Žå¸«
    public static final int QUEST_TUTOR2 = 304;//ä¿®ç·´å ´ç®¡ç†å“¡

    public static final int QUEST_END = 255; // çµ‚äº†æ¸ˆã¿ã‚¯ã‚¨ã‚¹ãƒˆã®ã‚¹ãƒ†ãƒƒãƒ—
