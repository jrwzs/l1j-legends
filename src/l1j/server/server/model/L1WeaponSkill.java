...
public class L1WeaponSkill {
	...
	static {
		if (Config.USE_INT_PROCS) {
            ...
            ProcMap.put(Fidelity_2HS, new L1WeaponSkill(Fidelity_2HS, 25, 0, 0, 0, 0, 0, 5524, 0, false, 8, 2.63));
            ProcMap.put(Fidelity_Bow, new L1WeaponSkill(Fidelity_Bow, 25, 0, 0, 0, 0, 0, 5524, 0, false, 8, 2.63));
            ProcMap.put(Fidelity_Claw, new L1WeaponSkill(Fidelity_Claw, 25, 0, 0, 0, 0, 0, 5524, 0, false, 8, 2.63));
            ProcMap.put(Fidelity_Edo, new L1WeaponSkill(Fidelity_Edo, 25, 0, 0, 0, 0, 0, 5524, 0, false, 8, 2.63));
