...
public class L1SkillUse {
    ...
    public boolean checkUseSkill(L1PcInstance player, int skillid, int target_id, int x, int y, String message, int time, int type,
        ...
        else if (type == TYPE_SPELLSC) { // ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â¹ÃƒÂ£Ã†â€™Ã…Â¡ÃƒÂ£Ã†â€™Ã‚Â«ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â¹ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â¯ÃƒÂ£Ã†â€™Ã‚Â­ÃƒÂ£Ã†â€™Ã‚Â¼ÃƒÂ£Ã†â€™Ã‚Â«ÃƒÂ¤Ã‚Â½Ã‚Â¿ÃƒÂ§Ã¢â‚¬ï¿½Ã‚Â¨ÃƒÂ¦Ã¢â€žÂ¢Ã¢â‚¬Å¡
        ...
        // ÃƒÂ£Ã†â€™Ã¢â‚¬Â¢ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â¡ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â¤ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â¢ÃƒÂ£Ã†â€™Ã‚Â¼ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â¦ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â©ÃƒÂ£Ã†â€™Ã‚Â¼ÃƒÂ£Ã†â€™Ã‚Â«ÃƒÂ£Ã¢â€šÂ¬Ã¯Â¿Â½ÃƒÂ£Ã†â€™Ã‚Â©ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â¤ÃƒÂ£Ã†â€™Ã¢â‚¬Â¢ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â¹ÃƒÂ£Ã†â€™Ã‹â€ ÃƒÂ£Ã†â€™Ã‚ÂªÃƒÂ£Ã†â€™Ã‚Â¼ÃƒÂ£Ã†â€™Ã‚ ÃƒÂ£Ã¯Â¿Â½Ã‚Â¯ÃƒÂ¨Ã‚Â©Ã‚ ÃƒÂ¥Ã¢â‚¬ï¿½Ã‚Â±ÃƒÂ¥Ã‚Â¯Ã‚Â¾ÃƒÂ¨Ã‚Â±Ã‚Â¡ÃƒÂ£Ã¯Â¿Â½Ã…â€™ÃƒÂ¥Ã‚ÂºÃ‚Â§ÃƒÂ¦Ã‚Â¨Ã¢â€žÂ¢
        // ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â­ÃƒÂ£Ã†â€™Ã‚Â¥ÃƒÂ£Ã†â€™Ã‚Â¼ÃƒÂ£Ã†â€™Ã¢â‚¬â€œÃƒÂ£Ã¯Â¿Â½Ã‚Â¯ÃƒÂ¨Ã‚Â©Ã‚ ÃƒÂ¥Ã¢â‚¬ï¿½Ã‚Â±ÃƒÂ¨Ã¢â€šÂ¬Ã¢â‚¬Â¦ÃƒÂ£Ã¯Â¿Â½Ã‚Â®ÃƒÂ¥Ã‚ÂºÃ‚Â§ÃƒÂ¦Ã‚Â¨Ã¢â€žÂ¢ÃƒÂ£Ã¯Â¿Â½Ã‚Â«ÃƒÂ©Ã¢â‚¬Â¦Ã¯Â¿Â½ÃƒÂ§Ã‚Â½Ã‚Â®ÃƒÂ£Ã¯Â¿Â½Ã¢â‚¬Â¢ÃƒÂ£Ã¢â‚¬Å¡Ã…â€™ÃƒÂ£Ã¢â‚¬Å¡Ã¢â‚¬Â¹ÃƒÂ£Ã¯Â¿Â½Ã…Â¸ÃƒÂ£Ã¢â‚¬Å¡Ã¯Â¿Â½ÃƒÂ¤Ã‚Â¾Ã¢â‚¬Â¹ÃƒÂ¥Ã‚Â¤Ã¢â‚¬â€œ
        ...
        if (l1object instanceof L1ItemInstance) {
            ...
            // ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â¹ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â­ÃƒÂ£Ã†â€™Ã‚Â«ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â¿ÃƒÂ£Ã†â€™Ã‚Â¼ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â²ÃƒÂ£Ã†â€™Ã†â€™ÃƒÂ£Ã†â€™Ã‹â€ ÃƒÂ£Ã¯Â¿Â½Ã…â€™ÃƒÂ§Ã‚Â²Ã‚Â¾ÃƒÂ©Ã…â€œÃ… ÃƒÂ£Ã¯Â¿Â½Ã‚Â®ÃƒÂ§Ã…Â¸Ã‚Â³ÃƒÂ£Ã¯Â¿Â½Ã‚Â«ÃƒÂ£Ã¯Â¿Â½Ã‚ÂªÃƒÂ£Ã¢â‚¬Å¡Ã¢â‚¬Â¹ÃƒÂ£Ã¯Â¿Â½Ã¢â‚¬Å“ÃƒÂ£Ã¯Â¿Â½Ã‚Â¨ÃƒÂ£Ã¯Â¿Â½Ã…â€™ÃƒÂ£Ã¯Â¿Â½Ã¢â‚¬Å¡ÃƒÂ£Ã¢â‚¬Å¡Ã¢â‚¬Â¹ÃƒÂ£Ã¢â€šÂ¬Ã¢â‚¬Å¡
            // LinuxÃƒÂ§Ã¢â‚¬â„¢Ã‚Â°ÃƒÂ¥Ã‚Â¢Ã†â€™ÃƒÂ£Ã¯Â¿Â½Ã‚Â§ÃƒÂ§Ã‚Â¢Ã‚ÂºÃƒÂ¨Ã‚ÂªÃ¯Â¿Â½ÃƒÂ¯Ã‚Â¼Ã‹â€ WindowsÃƒÂ£Ã¯Â¿Â½Ã‚Â§ÃƒÂ£Ã¯Â¿Â½Ã‚Â¯ÃƒÂ¦Ã…â€œÃ‚ÂªÃƒÂ§Ã‚Â¢Ã‚ÂºÃƒÂ¨Ã‚ÂªÃ¯Â¿Â½ÃƒÂ¯Ã‚Â¼Ã¢â‚¬Â°
            // 2008.5.4ÃƒÂ¨Ã‚Â¿Ã‚Â½ÃƒÂ¨Ã‚Â¨Ã‹Å“ÃƒÂ¯Ã‚Â¼Ã…Â¡ÃƒÂ¥Ã…â€œÃ‚Â°ÃƒÂ©Ã¯Â¿Â½Ã‚Â¢ÃƒÂ£Ã¯Â¿Â½Ã‚Â®ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â¢ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â¤ÃƒÂ£Ã†â€™Ã¢â‚¬ ÃƒÂ£Ã†â€™Ã‚ ÃƒÂ£Ã¯Â¿Â½Ã‚Â«ÃƒÂ©Ã‚Â­Ã¢â‚¬ï¿½ÃƒÂ¦Ã‚Â³Ã¢â‚¬Â¢ÃƒÂ£Ã¢â‚¬Å¡Ã¢â‚¬â„¢ÃƒÂ¤Ã‚Â½Ã‚Â¿ÃƒÂ£Ã¯Â¿Â½Ã¢â‚¬ ÃƒÂ£Ã¯Â¿Â½Ã‚Â¨ÃƒÂ£Ã¯Â¿Â½Ã‚ÂªÃƒÂ£Ã¢â‚¬Å¡Ã¢â‚¬Â¹ÃƒÂ£Ã¢â€šÂ¬Ã¢â‚¬Å¡ÃƒÂ§Ã‚Â¶Ã¢â€žÂ¢ÃƒÂ§Ã‚Â¶Ã…Â¡ÃƒÂ£Ã¯Â¿Â½Ã¢â‚¬â€�ÃƒÂ£Ã¯Â¿Â½Ã‚Â¦ÃƒÂ£Ã¢â‚¬Å¡Ã¢â‚¬Å¡ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â¨ÃƒÂ£Ã†â€™Ã‚Â©ÃƒÂ£Ã†â€™Ã‚Â¼ÃƒÂ£Ã¯Â¿Â½Ã‚Â«ÃƒÂ£Ã¯Â¿Â½Ã‚ÂªÃƒÂ£Ã¢â‚¬Å¡Ã¢â‚¬Â¹ÃƒÂ£Ã¯Â¿Â½Ã‚ ÃƒÂ£Ã¯Â¿Â½Ã¢â‚¬ËœÃƒÂ£Ã¯Â¿Â½Ã‚ÂªÃƒÂ£Ã¯Â¿Â½Ã‚Â®ÃƒÂ£Ã¯Â¿Â½Ã‚Â§return
            return false;
        }
    ...
    private boolean isNormalSkillUsable() {
        ...
        if (_user instanceof L1PcInstance) {
            ...
            */
            ...
            // DIGÃƒÂ£Ã¯Â¿Â½Ã‚Â¯ÃƒÂ£Ã†â€™Ã‚Â­ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â¦ÃƒÂ£Ã†â€™Ã¢â‚¬Â¢ÃƒÂ£Ã†â€™Ã‚Â«ÃƒÂ£Ã¯Â¿Â½Ã‚Â§ÃƒÂ£Ã¯Â¿Â½Ã‚Â®ÃƒÂ£Ã¯Â¿Â½Ã‚Â¿ÃƒÂ¤Ã‚Â½Ã‚Â¿ÃƒÂ§Ã¢â‚¬ï¿½Ã‚Â¨ÃƒÂ¥Ã¯Â¿Â½Ã‚Â¯
    ...
    /**
     * ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â¹ÃƒÂ£Ã†â€™Ã…Â¡ÃƒÂ£Ã†â€™Ã‚Â«ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â¹ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â¯ÃƒÂ£Ã†â€™Ã‚Â­ÃƒÂ£Ã†â€™Ã‚Â¼ÃƒÂ£Ã†â€™Ã‚Â«ÃƒÂ¤Ã‚Â½Ã‚Â¿ÃƒÂ§Ã¢â‚¬ï¿½Ã‚Â¨ÃƒÂ¦Ã¢â€žÂ¢Ã¢â‚¬Å¡ÃƒÂ£Ã¯Â¿Â½Ã‚Â«ÃƒÂ¤Ã‚Â½Ã‚Â¿ÃƒÂ§Ã¢â‚¬ï¿½Ã‚Â¨ÃƒÂ¨Ã¢â€šÂ¬Ã¢â‚¬Â¦ÃƒÂ£Ã¯Â¿Â½Ã‚Â®ÃƒÂ§Ã… Ã‚Â¶ÃƒÂ¦Ã¢â‚¬Â¦Ã¢â‚¬Â¹ÃƒÂ£Ã¯Â¿Â½Ã¢â‚¬Â¹ÃƒÂ£Ã¢â‚¬Å¡Ã¢â‚¬Â°ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â¹ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â­ÃƒÂ£Ã†â€™Ã‚Â«ÃƒÂ£Ã¯Â¿Â½Ã…â€™ÃƒÂ¤Ã‚Â½Ã‚Â¿ÃƒÂ§Ã¢â‚¬ï¿½Ã‚Â¨ÃƒÂ¥Ã¯Â¿Â½Ã‚Â¯ÃƒÂ¨Ã†â€™Ã‚Â½ÃƒÂ£Ã¯Â¿Â½Ã‚Â§ÃƒÂ£Ã¯Â¿Â½Ã¢â‚¬Å¡ÃƒÂ£Ã¢â‚¬Å¡Ã¢â‚¬Â¹ÃƒÂ£Ã¯Â¿Â½Ã¢â‚¬Â¹ÃƒÂ¥Ã‹â€ Ã‚Â¤ÃƒÂ¦Ã¢â‚¬â€œÃ‚Â­ÃƒÂ£Ã¯Â¿Â½Ã¢â€žÂ¢ÃƒÂ£Ã¢â‚¬Å¡Ã¢â‚¬Â¹
     *
     * @return false ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â¹ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â­ÃƒÂ£Ã†â€™Ã‚Â«ÃƒÂ£Ã¯Â¿Â½Ã…â€™ÃƒÂ¤Ã‚Â½Ã‚Â¿ÃƒÂ§Ã¢â‚¬ï¿½Ã‚Â¨ÃƒÂ¤Ã‚Â¸Ã¯Â¿Â½ÃƒÂ¥Ã¯Â¿Â½Ã‚Â¯ÃƒÂ¨Ã†â€™Ã‚Â½ÃƒÂ£Ã¯Â¿Â½Ã‚ÂªÃƒÂ§Ã… Ã‚Â¶ÃƒÂ¦Ã¢â‚¬Â¦Ã¢â‚¬Â¹ÃƒÂ£Ã¯Â¿Â½Ã‚Â§ÃƒÂ£Ã¯Â¿Â½Ã¢â‚¬Å¡ÃƒÂ£Ã¢â‚¬Å¡Ã¢â‚¬Â¹ÃƒÂ¥Ã‚ Ã‚Â´ÃƒÂ¥Ã¯Â¿Â½Ã‹â€
     */
    private boolean isSpellScrollUsable() {
        // ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â¹ÃƒÂ£Ã†â€™Ã…Â¡ÃƒÂ£Ã†â€™Ã‚Â«ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â¹ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â¯ÃƒÂ£Ã†â€™Ã‚Â­ÃƒÂ£Ã†â€™Ã‚Â¼ÃƒÂ£Ã†â€™Ã‚Â«ÃƒÂ£Ã¢â‚¬Å¡Ã¢â‚¬â„¢ÃƒÂ¤Ã‚Â½Ã‚Â¿ÃƒÂ§Ã¢â‚¬ï¿½Ã‚Â¨ÃƒÂ£Ã¯Â¿Â½Ã¢â€žÂ¢ÃƒÂ£Ã¢â‚¬Å¡Ã¢â‚¬Â¹ÃƒÂ£Ã¯Â¿Â½Ã‚Â®ÃƒÂ£Ã¯Â¿Â½Ã‚Â¯PCÃƒÂ£Ã¯Â¿Â½Ã‚Â®ÃƒÂ£Ã¯Â¿Â½Ã‚Â¿
        L1PcInstance pc = (L1PcInstance) _user;
        ...
        // ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â¤ÃƒÂ£Ã†â€™Ã‚Â³ÃƒÂ£Ã†â€™Ã¢â‚¬Å“ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â¸ÃƒÂ¤Ã‚Â¸Ã‚Â­ÃƒÂ£Ã¯Â¿Â½Ã‚Â«ÃƒÂ¤Ã‚Â½Ã‚Â¿ÃƒÂ§Ã¢â‚¬ï¿½Ã‚Â¨ÃƒÂ¤Ã‚Â¸Ã¯Â¿Â½ÃƒÂ¥Ã¯Â¿Â½Ã‚Â¯ÃƒÂ£Ã¯Â¿Â½Ã‚Â®ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â¹ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â­ÃƒÂ£Ã†â€™Ã‚Â«
    ...
    // ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â¤ÃƒÂ£Ã†â€™Ã‚Â³ÃƒÂ£Ã†â€™Ã¢â‚¬Å“ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â¸ÃƒÂ¤Ã‚Â¸Ã‚Â­ÃƒÂ£Ã¯Â¿Â½Ã‚Â«ÃƒÂ¤Ã‚Â½Ã‚Â¿ÃƒÂ§Ã¢â‚¬ï¿½Ã‚Â¨ÃƒÂ¥Ã¯Â¿Â½Ã‚Â¯ÃƒÂ¨Ã†â€™Ã‚Â½ÃƒÂ£Ã¯Â¿Â½Ã‚ÂªÃƒÂ£Ã¢â‚¬Å¡Ã‚Â¹ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â­ÃƒÂ£Ã†â€™Ã‚Â«ÃƒÂ£Ã¯Â¿Â½Ã¢â‚¬Â¹ÃƒÂ£Ã¢â‚¬Å¡Ã¢â‚¬â„¢ÃƒÂ¨Ã‚Â¿Ã¢â‚¬ï¿½ÃƒÂ£Ã¯Â¿Â½Ã¢â€žÂ¢
    ...
    public void handleCommands(L1PcInstance player, int skillId, int targetId, int x, int y, String message, int timeSecs, int type,
        ...
        try {
            // ÃƒÂ¤Ã‚ÂºÃ¢â‚¬Â¹ÃƒÂ¥Ã¢â‚¬Â°Ã¯Â¿Â½ÃƒÂ£Ã†â€™Ã¯Â¿Â½ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â§ÃƒÂ£Ã†â€™Ã†â€™ÃƒÂ£Ã¢â‚¬Å¡Ã‚Â¯ÃƒÂ£Ã¢â‚¬Å¡Ã¢â‚¬â„¢ÃƒÂ£Ã¯Â¿Â½Ã¢â‚¬â€�ÃƒÂ£Ã¯Â¿Â½Ã‚Â¦ÃƒÂ£Ã¯Â¿Â½Ã¢â‚¬Å¾ÃƒÂ£Ã¢â‚¬Å¡Ã¢â‚¬Â¹ÃƒÂ£Ã¯Â¿Â½Ã¢â‚¬Â¹ÃƒÂ¯Ã‚Â¼Ã…Â¸
