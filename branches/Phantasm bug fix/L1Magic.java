...
//			}
	...
	// ������ damage_dice�amage_dice_count�amage_value�P������������ ������
	private int calcMagicDiceDamage(int skillId) {
		...
		if ((_calcType == PC_PC) || (_calcType == PC_NPC)) {
			int spByItem = _pc.getSp() - _pc.getTrueSp(); // ��������P憭��
			charaIntelligence = _pc.getInt() + spByItem - 12;
		}
		else if ((_calcType == NPC_PC) || (_calcType == NPC_NPC)) {
			int spByItem = _npc.getSp() - _npc.getTrueSp(); // ��������P憭��
		...
		double criticalCoefficient = 1.5; // 擳������
		int rnd = Random.nextInt(100) + 1;
		if ((_calcType == PC_PC) || (_calcType == PC_NPC)) {
		...
		if ((_calcType == PC_PC) || (_calcType == PC_NPC)) { // �����INT����������
			magicDamage += _pc.getOriginalMagicDamage();
		}
		if ((_calcType == PC_PC) || (_calcType == PC_NPC)) { // ��������蕭������
	...
	// ������ 撅�扼�������頠賣�� ������
	// attr:0.�撅�折���,1.�擳��,2.�擳��,4.瘞湧���,8.憸券���(,16.�����)
	...
	public void commit(int damage, int drainMana) {
		...
		if ((_calcType == PC_PC) || (_calcType == PC_NPC)) {// �������摯嚗������
			...
			msg0 = _npc.getName() + "(擳)嚗�";
		}

		if ((_calcType == NPC_PC) || (_calcType == PC_PC)) { // �������摯嚗������
			msg4 = _targetPc.getName();
			msg2 = "嚗擗� " + _targetPc.getCurrentHp();
		}
		else if (_calcType == PC_NPC) { // �������戮嚗堆慫�����
			msg4 = _targetNpc.getName();
			msg2 = "嚗擗� " + _targetNpc.getCurrentHp();
		}
		...
		// 擳 撠� �璅� ��� X �摰喉�擗� Y��
		if ((_calcType == PC_PC) || (_calcType == PC_NPC)) { // �������摯嚗������
			_pc.sendPackets(new S_ServerMessage(166, msg0, msg1, msg2, msg3, msg4)); // \f1%0���%4%1%3
																						// %2
		}
		// �����(擳)嚗� X�摰喉�擗� Y��
		else if ((_calcType == NPC_PC)) { // �������摯嚗������
			_targetPc.sendPackets(new S_ServerMessage(166, msg0, null, msg2, msg3, null)); // \f1%0���%4%1%3
																							// %2
		}
	}
