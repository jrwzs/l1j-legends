...
public class L1Attack {
    ...
    private static final int[] PREVENT_DAMAGE = { ABSOLUTE_BARRIER, ICE_LANCE,
         ...
         * 0Ã¯Â½Å¾7Ã£ï¿½Â¾Ã£ï¿½Â§ -1, -1, 0, 0, 1, 1, 2, 2, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6,
         * 8Ã¯Â½Å¾26Ã£ï¿½Â¾Ã£ï¿½Â§ 7, 7, 7, 8, 8, 8, 9, 9, 9, 10, 10, 10, 11, 11, 11, 12, 12, 12,
         * 27Ã¯Â½Å¾44Ã£ï¿½Â¾Ã£ï¿½Â§ 13, 13, 13, 14, 14, 14, 15, 15, 15, 16, 16, 16, 17, 17, 17};
         * 45Ã¯Â½Å¾59Ã£ï¿½Â¾Ã£ï¿½Â§
         *
         ...
         * Ã¯Â¼â€™Ã¯Â¼â„¢Ã¯Â½Å¾Ã¯Â¼â€œÃ¯Â¼â€™Ã£ï¿½Â¯Ã¯Â¼â€™Ã¦Â¯Å½Ã£ï¿½Â«Ã¯Â¼â€¹Ã¯Â¼â€˜ if (str % 2 == 1) { dmg++; } strDmg[str] = dmg; } for (int
         * str = 33; str <= 39; str++) {
         * for (int str = 40; str <= 46; str++) {
         * strDmg[str] = dmg; } for (int str = 47; str <= 127; str++) {
         * Ã¯Â¼â€�Ã¯Â¼-Ã¯Â½Å¾Ã¯Â¼â€˜Ã¯Â¼â€™Ã¯Â¼-Ã£ï¿½Â¯Ã¯Â¼â€˜Ã¦Â¯Å½Ã£ï¿½Â«Ã¯Â¼â€¹Ã¯Â¼â€˜ dmg++; strDmg[str] = dmg; } }
         *
    ...
    public L1Attack(L1Character attacker, L1Character target, int skillId) {
        ...
        /* Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢-  Ã¥â€˜Â½Ã¤Â¸Â­Ã¥Ë†Â¤Ã¥Â®Å¡ Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢-  */
...
/*                              if (_pc.getMapId() >= 181 && _pc.getMapId() <= 190 && _weaponRange == 1 && !_pc.glanceCheck(_targetX, _targetY)) {
    ...
    /*
     * Ã¯Â¼Â°Ã¯Â¼Â£Ã£ï¿½Â¸Ã£ï¿½Â®Ã¥â€˜Â½Ã¤Â¸Â­Ã§Å½â€¡ Ã¯Â¼ï¿½Ã¯Â¼Ë†PCÃ£ï¿½Â®LvÃ¯Â¼â€¹Ã£â€šÂ¯Ã£Æ’Â©Ã£â€šÂ¹Ã¨Â£Å“Ã¦Â­Â£Ã¯Â¼â€¹STRÃ¨Â£Å“Ã¦Â­Â£Ã¯Â¼â€¹DEXÃ¨Â£Å“Ã¦Â­Â£Ã¯Â¼â€¹Ã¦Â­Â¦Ã¥â„¢Â¨Ã¨Â£Å“Ã¦Â­Â£Ã¯Â¼â€¹DAIÃ£ï¿½Â®Ã¦Å¾Å¡Ã¦â€¢Â°/2Ã¯Â¼â€¹Ã©Â­â€�Ã¦Â³â€¢Ã¨Â£Å“Ã¦Â­Â£Ã¯Â¼â€°Ãƒ-0.68Ã¯Â¼ï¿½10
     * Ã£ï¿½â€œÃ£â€šÅ’Ã£ï¿½Â§Ã§Â®-Ã¥â€¡ÂºÃ£ï¿½â€¢Ã£â€šÅ’Ã£ï¿½Å¸Ã¦â€¢Â°Ã¥â‚¬Â¤Ã£ï¿½Â¯Ã¨â€¡ÂªÃ¥Ë†â€ Ã£ï¿½Å’Ã¦Å“â‚¬Ã¥Â¤Â§Ã¥â€˜Â½Ã¤Â¸Â­(95%)Ã£â€šâ€™Ã¤Â¸Å½Ã£ï¿½Ë†Ã£â€šâ€¹Ã¤Âºâ€¹Ã£ï¿½Â®Ã£ï¿½Â§Ã£ï¿½ï¿½Ã£â€šâ€¹Ã§â€ºÂ¸Ã¦â€°â€¹Ã¥ï¿½Â´PCÃ£ï¿½Â®AC Ã£ï¿½ï¿½Ã£ï¿½â€œÃ£ï¿½â€¹Ã£â€šâ€°Ã§â€ºÂ¸Ã¦â€°â€¹Ã¥ï¿½Â´PCÃ£ï¿½Â®ACÃ£ï¿½Å’1Ã¨â€°Â¯Ã£ï¿½ï¿½Ã£ï¿½ÂªÃ£â€šâ€¹Ã¦Â¯Å½Ã£ï¿½Â«Ã¨â€¡ÂªÃ¥â€˜Â½Ã¤Â¸Â­Ã§Å½â€¡Ã£ï¿½â€¹Ã£â€šâ€°1Ã¥Â¼â€¢Ã£ï¿½â€žÃ£ï¿½Â¦Ã£ï¿½â€žÃ£ï¿½ï¿½
     * Ã¦Å“â‚¬Ã¥Â°ï¿½Ã¥â€˜Â½Ã¤Â¸Â­Ã§Å½â€¡5% Ã¦Å“â‚¬Ã¥Â¤Â§Ã¥â€˜Â½Ã¤Â¸Â­Ã§Å½â€¡95%
     */
    private boolean calcPcPcHit() {
        ...
        // if weapon is melee type, uncanny dodge applies - [Hank]
        if (_weaponType != 20)
        {
    ...
    private boolean calcErEvasion() {
        ...
        /* Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢-  Ã£Æ’â‚¬Ã£Æ’Â¡Ã£Æ’Â¼Ã£â€šÂ¸Ã§Â®-Ã¥â€¡Âº Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢-  */
    ...
    /* Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢-  Ã¦â€�Â»Ã¦â€™Æ’Ã£Æ’Â¢Ã£Æ’Â¼Ã£â€šÂ·Ã£Æ’Â§Ã£Æ’Â³Ã©â‚¬ï¿½Ã¤Â¿Â¡ Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢-  */
    public void action() {
        if (_calcType == PC_PC || _calcType == PC_NPC) {
            actionPc();
    ...
    private void actionNpc() {
         ...
         *
         * head)
         * Ã¯Â¼Â¸Ã¦-Â¹Ã¥ï¿½â€˜Ã£ï¿½Â®Ã£â€šÂ¿Ã£Æ’Â¼Ã£â€šÂ²Ã£Æ’Æ’Ã£Æ’Ë†Ã£ï¿½Â¾Ã£ï¿½Â§Ã£ï¿½Â®Ã¨Â·ï¿½Ã©â€ºÂ¢ float dis_y = Math.abs(cy - _targetY);
        ...
        /* Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢-  Ã¨Â¨Ë†Ã§Â®-Ã§Âµï¿½Ã¦Å¾Å“Ã¥ï¿½ï¿½Ã¦Ëœ  Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢-  */
    ...
    public void commit() {
        ...
        if ((_calcType == PC_PC) || (_calcType == PC_NPC)) {
            ...
            msg0 = _npc.getNameId() + "(Ã§â€°Â©Ã¦â€�Â»)Ã¯Â¼Å¡";
        }

        if ((_calcType == NPC_PC) || (_calcType == PC_PC)) {
            msg4 = _targetPc.getName();
            msg2 = "Ã¯Â¼Å’Ã¥â€°Â©Ã©Â¤Ëœ " + _targetPc.getCurrentHp() + "Ã¯Â¼Å’Ã¥â€˜Â½Ã¤Â¸Â­     " + _hitRate + "%";
        } else if (_calcType == PC_NPC) {
            msg4 = _targetNpc.getNameId();
            msg2 = "Ã¯Â¼Å’Ã¥â€°Â©Ã©Â¤Ëœ " + _targetNpc.getCurrentHp() + "Ã¯Â¼Å’Ã¥â€˜Â½Ã¤Â¸Â­ " + _hitRate + "%";
        }
        msg3 = _isHit ? _damage + " Ã¥â€šÂ·Ã¥Â®Â³" : "  0 Ã¥â€šÂ·Ã¥Â®Â³";
    ...
    private void commitNpc() {
        ...
        /* Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢-  Ã£â€šÂ«Ã£â€šÂ¦Ã£Æ’Â³Ã£â€šÂ¿Ã£Æ’Â¼Ã£Æ’ï¿½Ã£Æ’ÂªÃ£â€šÂ¢ Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢- Ã¢-  */
    ...
    /*
     * Ã¦Â­Â¦Ã¥â„¢Â¨Ã£â€šâ€™Ã¦ï¿½ï¿½Ã¥â€šÂ·Ã£ï¿½â€¢Ã£ï¿½â€ºÃ£â€šâ€¹Ã£â‚¬â€š Ã¥Â¯Â¾NPCÃ£ï¿½Â®Ã¥ Â´Ã¥ï¿½Ë†Ã£â‚¬ï¿½Ã¦ï¿½ï¿½Ã¥â€šÂ·Ã§Â¢ÂºÃ§Å½â€¡Ã£ï¿½Â¯10%Ã£ï¿½Â¨Ã£ï¿½â„¢Ã£â€šâ€¹Ã£â‚¬â€šÃ§Â¥ï¿½Ã§Â¦ï¿½Ã¦Â­Â¦Ã¥â„¢Â¨Ã£ï¿½Â¯3%Ã£ï¿½Â¨Ã£ï¿½â„¢Ã£â€šâ€¹Ã£â‚¬â€š
     */
    private void damageNpcWeaponDurability() {
        ...
        int bchance = 3;
                ...
                /*
                 * Ã¦ï¿½ï¿½Ã¥â€šÂ·Ã£ï¿½-Ã£ï¿½ÂªÃ£ï¿½â€žNPCÃ£â‚¬ï¿½Ã§Â´ Ã¦â€°â€¹Ã£â‚¬ï¿½Ã¦ï¿½ï¿½Ã¥â€šÂ·Ã£ï¿½-Ã£ï¿½ÂªÃ£ï¿½â€žÃ¦Â­Â¦Ã¥â„¢Â¨Ã¤Â½Â¿Ã§â€�Â¨Ã£â‚¬ï¿½SOFÃ¤Â¸Â­Ã£ï¿½Â®Ã¥ Â´Ã¥ï¿½Ë†Ã¤Â½â€¢Ã£â€šâ€šÃ£ï¿½-Ã£ï¿½ÂªÃ£ï¿½â€žÃ£â‚¬â€š
                 */
        if ((_calcType != PC_NPC)
    ...
    /*
     * Ã£Æ’ï¿½Ã£â€šÂ¦Ã£Æ’Â³Ã£â€šÂ¹Ã£â€šÂ¢Ã£â€šÂ¿Ã£Æ’Æ’Ã£â€šÂ¯Ã£ï¿½Â«Ã£â€šË†Ã£â€šÅ Ã¦Â­Â¦Ã¥â„¢Â¨Ã£â€šâ€™Ã¦ï¿½ï¿½Ã¥â€šÂ·Ã£ï¿½â€¢Ã£ï¿½â€ºÃ£â€šâ€¹Ã£â‚¬â€š Ã£Æ’ï¿½Ã£â€šÂ¦Ã£Æ’Â³Ã£â€šÂ¹Ã£â€šÂ¢Ã£â€šÂ¿Ã£Æ’Æ’Ã£â€šÂ¯Ã£ï¿½Â®Ã¦ï¿½ï¿½Ã¥â€šÂ·Ã§Â¢ÂºÃ§Å½â€¡Ã£ï¿½Â¯10%
     */
