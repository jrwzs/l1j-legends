...
public class S_ShopSellList extends ServerBasePacket {
	...
	public S_ShopSellList(int objId, L1PcInstance pc) {
		...
		for (int i = 0; i < shopItems.size(); i++) {
            ...
            //calc.layTax((int) (shopItem.getPrice() * Config.RATE_SHOP_SELLING_PRICE));
			writeD(i);
			...
			if (shopItem.getPackCount() > 1) {
				...
				if (item.getItemId() == 40309) {// é£Ÿäººå¦–ç²¾RaceTicket
		...
		// Not showing 100/10000 adena amount for Arnea merchant - [Hank]
		if(npcId == 100053)
		{
			writeH(0x00); // 0x00:kaimo 0x01:pearl 0x07:adena
		}
		else{
