...
*/
    ...
    private void addMagicList(L1Character cha, boolean repetition) {
        try
        {
            ...
            // Excluding this part will make the code reads the duration directly from DB, that's why the Maximum Stun was 3s - [Hank]
            ...
            // if shock_Stun and Bone Break being used, check if the target has the effect- [Hank]
            else if (_skillId == Skill_ShockStun || _skillId == Skill_BoneBreak)
            {
            	 if(cha instanceof L1PcInstance)
                 {
            ...
            for (Iterator<TargetStatus> iter = _targetList.iterator(); iter.hasNext();) {
                ...
                switch(_skillId) {
                    ...
                    case Skill_EarthBind:
                    	_earthBindDuration = L1Stun.Stun(_user,cha,_skillId);
//
//                        int tarLevel = 0;
//                        int levelDiff = 0;
//
